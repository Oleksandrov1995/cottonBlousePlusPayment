        ...
        <section className='ourBenefits'>
            ...
            <ul className='ourBenefits-list'>
                ...
                <li className='ourBenefits-item'>
                    ...
                    <p className='ourBenefits-text'>Можливий накладний платіж з частковою передплатою всього 86 грн або повна оплата на карту з наданням фіксального чеку на товар (фіксальний чек надішлемо повідомленням)</p>
                </li>
                <li className='ourBenefits-item '>
